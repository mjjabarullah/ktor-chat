...
export const Success = {
    ...
    NEWS_CREATED: 'Announcement created',
    NEWS_DELETED: 'Announcement deleted',
    ADMINSHIP_CREATED: 'Adminship post created',
    ADMINSHIP_DELETED: 'Adminship post deleted',
    GLOBAL_FEED_CREATED: 'Global Feed post created',
    GLOBAL_FEED_DELETED: 'Global Feed post deleted',
